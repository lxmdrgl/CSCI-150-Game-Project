...
public class PlayerNormalAirState : PlayerAirState
{
    ...
    public override void LogicUpdate()
    {
        ...
        if (!isExitingState) 
        {
            ...
            {   
                // // test Debug.Log($"Air State: Platform State: isPlatformOverlap: {isPlatformOverlap != null}, isPlatformOverlapTop: {isPlatformOverlapTop != null}");
                // // test Debug.Log("Air to Platform:" + Movement.CurrentVelocity.y + ", isJumpingInPlatform: " + isJumpingInPlatform);
                isExitingState = true;
