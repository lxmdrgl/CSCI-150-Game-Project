...
public class Authentication : MonoBehaviour
{
    ...
    async Task SignUpWithUsernamePasswordAsync(string username, string password) // Sign Up API
    {
        try
        {
            ...
            // test Debug.Log("SignUp is successful.");
            AuthMenuSignedIn();
        }
    ...
    public void SignOut()
    {
        try
        {
            ...
            // test Debug.Log("Player signed out successfully.");
            AuthMenuSignedOut();
        }
        catch (System.Exception ex)
        {
            // test Debug.LogError($"Sign out failed: {ex.Message}");
    ...
    private async Task LoadPlayerName()
    {
        ...
        {
            // test Debug.LogError("Failed to load player name: " + ex.Message);
