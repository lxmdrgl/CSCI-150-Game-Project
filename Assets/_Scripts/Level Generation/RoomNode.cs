...
public class RoomNode : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        if (transform.parent != null)
        {
            ...
            if (parent != null)
            {
                ...
                // // test Debug.Log(gameObject.name + ": " + parent.gameObject.name + "->" + gameObject.name);
            }
        }
        ...
        foreach (Transform childTransform in transform)
        {
            ...
            {
                AddChild(childNode);
                // // test Debug.Log(gameObject.name + ": " + gameObject.name + "->" + childNode.gameObject.name);
            }
        }   
    }
    ...
    {
        // test Debug.Log(new string('-', depth * 2) + gameObject.name);
