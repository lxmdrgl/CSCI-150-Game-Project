...
public class EE_UpwardRangedAttack : RangedAttackState
{
    private ExplosiveEnemy enemy;

    public EE_UpwardRangedAttack(Entity entity, string animBoolName, Transform attackPosition, D_RangedAttackState stateData, ExplosiveEnemy enemy) 
    ...
    public override void LogicUpdate()
    {
        ...
        if (isAnimationFinished)
        {
            ...
            {
                projectileScript.FireProjectile(stateData.projectileSpeed, stateData.projectileTravelDistance, enemy.player.position, "radialNoGravity", enemy.transform.rotation.y, stateData.gravityScale);
            }
