...
public class E5_MeleeDashState : MeleeAttackState
{
    ...
    public override void Enter()
    {
        ...
        // test Debug.LogWarning("Enemy 5 Y jump: " + + Movement?.CurrentVelocity.y);
    }
    ...
    public override void LogicUpdate()
    {
        ...
        // test Debug.Log("Enemy 5 Y: " + Movement?.CurrentVelocity.y);

        if (!triggeredAttack) {
            // test Debug.Log("Triggering attack in MeleeDashState: " + triggeredAttack);
