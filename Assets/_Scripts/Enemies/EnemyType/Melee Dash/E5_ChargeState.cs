...
public class E5_ChargeState : ChargeState
{
    ...
    public override void LogicUpdate()
    {
        ...
        // test Debug.Log("Enemy Charge State: " + isPlayerInPursuitRange + " " + isPlayerInAgroRange + " " + performCloseRangeAction + " " + isDetectingLedge + " " + isDetectingWall);
        if (performCloseRangeAction)
        {
            // test Debug.Log("Perform close range action");
        ...
        // {
        //     // test Debug.Log("Enter idle state");
        //     stateMachine.ChangeState(enemy.idleState);
        // }
        else if (!isDetectingLedge || isDetectingWall)
        {
            // test Debug.Log("Enter look 2 state");
            stateMachine.ChangeState(enemy.lookForPlayerState);
        }
    }
